 ...
 * @e_ident: containing the ELF magic numbers.
 *
 ...
 *
 * Description: Magic numbers are separated spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: A array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
	printf("  OS/ABI:                            ");
 ...
 * @e_ident: A array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
